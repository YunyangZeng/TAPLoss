...
def Pysepm_STOI(ref, est, sr=16000):
    return pysepm.stoi(ref, est, sr)
def Pysepm_PESQ(ref, est, sr=16000):
    return pysepm.pesq(ref, est, sr)[1]            
...
REGISTERED_METRICS = {
    ...
    "WB_PESQ": WB_PESQ,
    "NB_PESQ": NB_PESQ,
    "Pysepm_PESQ": Pysepm_PESQ,
    "Pysepm_STOI": Pysepm_STOI
}
